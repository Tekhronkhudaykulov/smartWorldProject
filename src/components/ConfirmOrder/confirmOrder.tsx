            ...
            >
                <div className={styles.content}>
                    ...
                    <div className={styles.btnBox}>
                        <Title onPress={() => Submit()} style={{ cursor: "pointer" }} title='Да' color={COLORS.grey} fontSize='28px' />
                        <Title onPress={() => BackOrder()} style={{ cursor: "pointer" }} title='Нет' color={COLORS.grey} fontSize='28px' />
                    </div>
                </div>
            </Backdrop>
        </div>
